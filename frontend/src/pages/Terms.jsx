    ...
    return (
        <div className="min-h-screen bg-default-50 pt-20 pb-20">
            <div className="max-w-4xl mx-auto px-6">
                ...
                >
                    <h1 className="text-4xl font-bold text-foreground font-heading mb-8">Terms and Conditions</h1>
                    ...
                    <div className="prose prose-lg max-w-none">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-foreground mb-4">3. Data Privacy</h2>
                            <p className="text-default-600 mb-4">
